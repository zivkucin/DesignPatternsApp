...
public class DlgHexagon extends JDialog {
			...
			getContentPane().add(btnPanel, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
						...
						getToolkit().beep();
								...
								if (hexagonToEdit != null) {
									int x = Integer.parseInt(txtXCoord.getText());
									int y = Integer.parseInt(txtYCoord.getText());
									int r = Integer.parseInt(txtRadius.getText());
									hexagonToEdit.setCenterX(x);
									hexagonToEdit.setCenterY(y);
									hexagonToEdit.setR(r);
									hexagonToEdit.setOutline(outline);
									hexagonToEdit.setFill(area);
								}
	...
	public void setHexagonToEdit(Hexagon h) {
		this.hexagonToEdit = h;
		txtXCoord.setText(String.valueOf(h.getCenterX()));
		txtYCoord.setText(String.valueOf(h.getCenterY()));
		txtRadius.setText(String.valueOf(h.getR()));
		outline = h.getOutline();
		area = h.getFill();
	}
